 ...
 */
const schema = buildSchema(fs.readFileSync(__dirname + '/../proto/comment.gql', 'utf-8'));

/**
 * 一个后台服务（可以理解为微服务）使用一个端口，所以对应前端也需要一个服务一个rpcclient
 */
const commentClient = require('./data/comment-client');
const praiseClient = require('./data/praise-client');
